...
async function scrapeAutopistaLosLibertadores(patente) {
  const browser = await puppeteer.launch();
  const page = await browser.newPage();
  await page.goto('https://www.autopistaloslibertadores.cl/pago/pago.html');
...
// Ejemplo de uso
scrapeAutopistaLosLibertadores('HDTL88').then((result) => {
  console.log(result);
});